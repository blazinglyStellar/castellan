...
import { getBalance, getDeposits, ApiError } from "@/lib/api/endpoints";
import {
  Card,
  CardContent,
  CardHeader,
...
const XLM_LOGO = (
  <span className="inline-flex items-center justify-center rounded-sm bg-muted px-1 py-0.5 text-[10px] font-bold leading-none text-muted-foreground">
    XLM
  </span>
);
